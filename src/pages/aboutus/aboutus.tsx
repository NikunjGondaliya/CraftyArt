        ...
        <section className="about_us py-5">
          <div className="container-fluid">
            <div className="about_us_header text-center container">
              ...
              <h4 className="about_section_title mb-2">
                Welcome to Crafty Art,
              </h4>
              <p>
          ...
          <img src="assets/images/sectionimg/aboutnewbg.png" alt="">
            ...
            <div className="template_inner">
              ...
              <div className="template_content w-75 mx-auto">
                <p>
                  Unlimited templates provide users with a wide range of
                  creative options for all their design projects.{" "}
                </p>
                <p>
                  With a selection of ready-made and custom-made templates,
                  users can quickly and easily create unique designs for logos,
                  flyers, invitations, and more.
                </p>
                <p>
                  {" "}
            ...
            <div className="row">
              ...
              <div className="col-md-7 mt-md-0 mt-3 px-3">
                <div className="design_tool_right h-100 d-flex justify-content-center flex-column template_content">
                  ...
                  <p>
                    An online graphic design tool Crafty Art is a digital
                    platform that enables users to create professional-looking
                    artwork using a variety of tools and templates.
                  </p>
                  <p>
