  ...
  <section className="hero d-none d-sm-block">
    <div className="hero_inner">
      <div className="hero_heading text-center d-flex justify-content-center align-items-center h-100 flex-column">
        <h1 className="main_heading mb-0">Graphic Design Tool | Crafty Art</h1>
        <p className="comman_para my-2 py-2">
          Create eye-catching visual content for social media in minutes - it’s
          easy, fast, and free! Pick a template, customize it, and post.
        </p>
      </div>
  ...
  <main className="template_design pt-4">
    <div className="section_heading text-center container-fluid d-none d-sm-block">
      ...
      <p className="comman_para w-75 mx-auto">
        ...
        Maker, Invitation Card Maker, Poster Maker, Thumbnail Maker, Instagram
        Story Maker, Facebook Story Maker, Resume Maker, YouTube Banner
        Template, Festival Poster Maker, Diwali Poster, Book Cover Templates,
        Calendar Templates, Portrait Certificate Template, Visiting Card Design,
        Bio Data for Marriage, Bio Data Format, Bio Data Editor and Graphic
        Design with Crafty Art.
      </p>
    </div>
    {/* ========== LATEST TEMPALTE ======== */}
    <section className="latest_templates mt-2">
      <div className="container-fluid">
        <div className="section_title_main d-flex justify-content-between align-items-center pb-3">
          ...
          <Link to="/alltemplate" className="show_more_link text-decoration-none me-3">Show more</Link>
            ...
            <div className="owl-carousel carousel-main latest_templates_swiper">
              <div className="single_template_card">
                ...
                <div className="img_small_title mt-2">
                  <h6 className="mb-0">
                    Bright Yellow and Black Photographic Fitness Service Website
                  </h6>
                  <span>Website</span>
                </div>
              </div>
              ...
              <div className="col-md-6 mt-3 mt-md-0">
                <div className="d-flex justify-content-center flex-column h-100">
                  <h5 className="custom_temp_heading mb-3 color_midnight text-start">
                    "Create Custom Invitations with Crafty Art for Your Special
                    Events"
                  </h5>
                  <p className="custom_temp_text mb-3">
                    If you are looking to create beautiful wedding and birthday
                    invitations, then look no further than Crafty Art. This
                    online graphic design tool is the perfect solution for
                    creating stunning and customized invitations that will get
                    your guests excited to attend your special event.
                  </p>
                  <p className="custom_temp_text mb-3">
              ...
              <div className="col-md-6 mt-3 mt-md-0">
                <div className="d-flex justify-content-center flex-column h-100">
                  ...
                  <p className="custom_temp_text mb-3">
                    ...
                    certificates, thumbnails, and Instagram stor y posts without
                    watermarks.
                  </p>
                  <p className="custom_temp_text mb-3">
                    {" "}
            ...
            <div className="row">
              ...
              <div className="col-md-6 mt-3 mt-md-0">
                <div className="d-flex justify-content-center flex-column h-100">
                  ...
                  <p className="custom_temp_text mb-3">
                    You can access a wide range of templates, fonts, colors, and
                    more to customize your designs to your exact specifications.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="row">
              ...
              <div className="col-md-6 mt-3 mt-md-0">
                <div className="d-flex justify-content-center flex-column h-100">
                  ...
                  <p className="custom_temp_text mb-3">
                    Crafty Art also offers a online free logo maker and download
                    option.
                  </p>
                  <p className="custom_temp_text mb-3">
          ...
          <div className="swiper-slide">
            <div className="row">
              ...
              <div className="col-md-6 mt-3 mt-md-0">
                <div className="d-flex justify-content-center flex-column h-100">
                  <h5 className="custom_temp_heading mb-3 color_midnight text-start">
                    "Unlock Your Creative Potential with Our prestigious Design
                    Tool!"
                  </h5>
                  <p className="custom_temp_text mb-3">
                    Creating beautiful template designs is now easier than ever
                    with Crafty Art.
                  </p>
                  <p className="custom_temp_text mb-3">
                    Whether you're looking to create logos, Insta posts, Insta
                    Story Maker, thumbnail maker without watermark, free resume
                    maker or certificates, you can do it all with Crafty Art.
                    With its ease of use, the wide selection of templates and
                    fonts, free logo maker and download options, you can create
                    stunning graphics in no time. Get creative and start
                    crafting with Crafty Art today!
                  </p>
                </div>
              </div>
            </div>
